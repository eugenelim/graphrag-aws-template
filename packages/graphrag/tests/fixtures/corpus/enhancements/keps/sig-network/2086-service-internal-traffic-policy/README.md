...
A new field `internalTrafficPolicy` on Services lets cluster operators restrict
internal traffic to endpoints on the same node as the originating Pod, reducing
cross-node hops for node-local workloads.
